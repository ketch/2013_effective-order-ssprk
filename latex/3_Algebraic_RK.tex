...
Classical order conditions follow from comparing the elementary weights 
...
and applying the product operation \eqref{eq:Group_operation}.
...
\begin{remark}\label{rem:talltrees}
	...
	This follows from inductive application of the product operation \eqref{eq:Group_operation}
	on the tall trees. 
