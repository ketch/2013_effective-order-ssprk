...
and then a finishing method $S^{-1}$: i.e., the inverse of $S$ which
...
\begin{table}[t]
	...
	\begin{multicols}{2}
    	...
    	\end{align*}
    \end{multicols}
    \caption{Effective order conditions of the main method for trees up to order five.  \textbf{uncommented temporarily, remove later?}}
    \label{tab:effectiveOCs}
\end{table}

\colintodo{This ``construction'' but should move elsewhere but I think it supports the table}
