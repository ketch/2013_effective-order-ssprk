...
\yiannistodo{I think you should mention that functions in $G$ correspond to classes of RKm and not a single method. Especially to clarify the replacement of $SM$ and $MS^{-1}$ by $R$ and $T$ in section 5.}
...
\yiannistodo{What about this minor change? We keep Butcher's notation and remove any ambiguities.}
...
\section{Constructing methods and an effective order barrier}
