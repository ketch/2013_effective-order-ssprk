...
\begin{table}
  ...
  \begin{tabular}{ccc}
    ...
    $i$ & tree & elementary weight \\
    \hline
    9  & \tree{9}                 & $\bm{b}^T\bm{c}^4$ (need strut)\\
    10 & \tree{10}                & $\bm{b}^TCCA\bm{c}$ \\
    11 & \:\:\:\:\:\tree{11}      & $\bm{b}^TCA\bm{c}^2$ (Check) \\
    12 & \tree{12}\:\:\:\:        & $\bm{b}^TCAA\bm{c}$ \\
    13 & \:\:\:\:\:\tree{13}      & $\bm{b}^T \text{diag}(A\bm{c}) A\bm{c}$ (I forget) \\
    14 & \tree{14}\:\:\:\:        & $\bm{b}^TA\bm{c}^3$ \\
    15 & \:\:\:\:\:\tree{15}      & $\bm{b}^TACA\bm{c}$ \\
    16 & \tree{16}\:\:\:\:\:      & $\bm{b}^TA^2\bm{c}^2$ \\
    17 & \:\:\:\:\:\tree{17}      & $\bm{b}^TA^3\bm{c}$ \\
  \end{tabular}
