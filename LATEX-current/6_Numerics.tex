...
\begin{figure}[t!]
    \centering
    \subfloat[$\sigma = 6.0$]{\label{fig5.3a}\includegraphics[scale=0.6]{Pictures/burgers_cont_tvd.eps}}\subfloat[$\sigma = 7.1$]{\label{fig5.3b}\includegraphics[scale=0.6]{Pictures/burgers_cont_no_tvd.eps}}
    \caption{Solution of Burger's equation with continuous initial data, using a $ TM^{n}R $ scheme, where $ M $ is SSPRK($ 10 $,$ 4 $,$ 3 $). The SSP coefficient is $ c = 6.0 $.}
    \label{fig5.3}
\end{figure}
...
\begin{figure}[t!]
    \centering
    \subfloat[$\sigma = 1.97$]{\label{fig5.4a}\includegraphics[scale=0.6]{Pictures/burgers_discont_tvd.eps}}\subfloat[$\sigma = 2.2$]{\label{fig5.4b}\includegraphics[scale=0.6]{Pictures/burgers_discont_no_tvd.eps}}
