...
The main result of this section can be summarised in the next theorem.%, which allows 
...
\begin{theorem}\label{thm:effective_barrier}
	...
	has effective order at most four.
\end{theorem}
The proof of Theorem~\ref{thm:effective_barrier} relies on a lemma and it is stated 
at the end of this section.
We concluse in the following result.
