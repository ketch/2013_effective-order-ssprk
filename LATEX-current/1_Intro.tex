...
\davidtodo{The second paragraph seems disconnected from the first.}\yiannistodo{What about now?}
...
development of high accurate non-oscillatory methods. \yiannistodo{... strongly stable or nonlinearly stable ..., which do you prefer?}
...
free of oscillations \cite{Shu/Osher:1988}, positivity \cite{Horvath:2005}, etc \yiannistodo{suggested citations}) are preserved 
...
\davidtodo{It seems strange to say often, when what is meant is "whenever the method is explicit".} \yiannistodo{since implicit 1st order are unconditionally SSP}
