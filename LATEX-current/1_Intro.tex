...
\davidtodo{The second paragraph seems disconnected from the first.}
...
Often the combination is subject to a time step size restriction.\davidtodo{It seems strange to say often, when what is meant is "whenever the method is explicit".}
