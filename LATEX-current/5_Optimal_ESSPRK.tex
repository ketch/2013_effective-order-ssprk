...
\colintodo{If $q=p$ its just a classical RK method right? why need this notation?}
...
\colintodo{Why do we need to mention this?  Of course we use full DoF}
...
\begin{proof}
  ...
  %the order conditions and the radius of absolute monotonicity conditions
...
\end{equation}
and therefore,
\colintodo{I removed $^{n-2}$ from $\alpha$ and added $^3$ to $E$.}
