...
The only remaining cases are $q=4, s\ne 10$; those are discussed below.
...
stopping method to obtain them.  Furthermore, changing stepsize would require first applying the stopping method with the old stepsize and then applying the starting method with the new stepsize.
