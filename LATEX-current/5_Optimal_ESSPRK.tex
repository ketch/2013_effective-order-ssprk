...
\begin{result}
	...
	$\sspcoef=\clin$.
\end{result}
\davidtodo{Could we call this a remark instead?}
...
\begin{theorem}\label{thm:ESSPRK(3,3,2)}
    ...
    \begin{displaymath}
        ...
        \end{split}
    \end{displaymath}
    where $1/4 \leq \gamma \leq 1$ is a free parameter. We refer to the above family as 
    ESSPRK($3,3,2$).\davidtodo{This is a bit strange, since that notation was defined to refer to a single method.}
\end{theorem}
\begin{theorem}\label{thm:ESSPRK(4,3,2)}
    ...
    \begin{displaymath}
        ...
        \end{split}
    \end{displaymath}
    where $ 1/6 \leq \gamma \leq 1/2 $ is a free parameter. We refer to the 
