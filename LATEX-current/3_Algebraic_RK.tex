...
of rooted trees.
\yiannistodo{We still have to cite Butcher here.}
\davidtodo{Did he propose the group (whatever that means),
or did he show that it is isomorphic to the Runge--Kutta group?}
\colintodo{I wish to avoid explicitly discussing more than one group.
  Is it ok now?}
