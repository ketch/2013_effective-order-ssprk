...
% TODO: I removed this re: referee's comment but could put it back
...
\begin{table}
    ...
    \caption{Effective order five conditions on $\alpha$ (main method $M$) in terms of order 
    				conditions on $\beta$ (starting method $S$).
...
\textbf{Todo:} Jim not keen on including this table...
perhaps we could add dashed lines to separate orders like in Table~\ref{tab:rho_tau_OCs}.
}
