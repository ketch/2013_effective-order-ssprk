...
\colintodo{Reverted: I think its fine: $\alpha$ corresponds to $A$---maybe other things too}.
...
% the convention is in the whole book, not much of a convention if just one theorem!
