...
389A]{Butcher2008_book}, the proof of which shows that if a method $M$
has effective order $p$ with particular starting and stopping methods
(for which $\beta_1 \neq 0$), then $M$ is also effective order $p$
with another pair of starting and stopping methods which do have
$\beta_1=0$.
