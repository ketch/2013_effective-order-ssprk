...
This\davidtodo{What?} is overly restrictive for practical purposes and we want a way to
...
\begin{definition}\label{def:Equivalent_methods}
	Two Runge--Kutta methods
        are equivalent up to order $p$ if their corresponding elements in $G$, $\alpha$ and $\beta$, satisfy
	\begin{displaymath}
