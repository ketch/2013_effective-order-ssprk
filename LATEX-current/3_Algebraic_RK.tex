...
\begin{table}
	...
	\begin{smalltrees}
		\begin{tabular}{ccccccc}
  		...
  		\end{tabular}
  \end{smalltrees}
  \caption{Elementary weights of trees up to fifth order for a Runge--Kutta method $(A,\bm{b})$. Here $C$ is a diagonal matrix with components $c_i = \sum_j^s a_{ij}$ and exponents of vectors represent component exponentiation.}
...
\colintodo{leave here for now please.  Could call it something other than ``Result''}
\yiannistodo{Yes keep it here.}
...
\yiannistodo{We can remove this line. We don't use this notation further in the text.}
...
(Tables~\ref{tab:effective_OCs} and~\ref{tab:Effective_oc} both make
this assumption).
