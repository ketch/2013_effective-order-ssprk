...
\colintodo{My interpretation of Butcher is that ``the Runge--Kutta
  group'' refers to $G$ (\S 383).
  Confusingly, \S 382 is ``the group of Runge--Kutta methods'' which
  refers to composition and equivalence classes.
  I wish to avoid explicitly discussing more than one group.
  Is it ok now?}
