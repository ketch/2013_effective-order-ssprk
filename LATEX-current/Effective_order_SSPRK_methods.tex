...
\begin{document}
	...
	\begin{abstract}
  		...
  		preserving (SSP) Runge--Kutta methods. These methods of effective order
  		...
  		particular, we present four-stage effective order four SSP explicit Runge--Kutta
  		methods which is not possible using four stages and classical
  		order. Numerical experiments demonstrate the feasibility of
  		effective order in practice. We prove that methods of effective
  		order five cannot have strictly positive weights. A direct
