...
%\documentclass[final]{siamltex}  % TODO: siam

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% Preamble %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%	

%%% packages %%%
\usepackage{amsmath,amssymb,amsfonts}
\usepackage{amsthm}   % TODO: turn off for siam style
...
% TODO: turn off above but leave this for siam style
...
\author{
	Yiannis Hadjimichael\thanks{4700 King Abdullah University of Science \& Technology,
...
\begin{document}
	...
	%\bibliographystyle{siam}  % TODO: turn on for siam style
