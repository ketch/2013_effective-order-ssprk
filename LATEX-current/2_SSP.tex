...
are monotonic in the total variation seminorm \cite{Ketcheson2008}.
...
non-increasing (in time) in some norm, seminorm, or convex functional; i.e.,
...
Clearly for any $s$-stage method of order $q$,
